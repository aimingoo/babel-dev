...
const ClassMemberModifierWithAs = ["public", "private", "protected"];
...
export default class StatementParser extends ExpressionParser {
  ...
  // Some code from ../plugins/typescript/index.js
  tsTryParse<T>(f: () => ?T): ?T {
  ...
  tsParseModifier<T: ClassMemberModifier>(allowedModifiers: T[]): ?T {
  ...
  parseTrySpecialClassMemberName(classBody, member, isStatic, containsEsc) {
    let key = this.parseIdentifier(true); // eats '<key>'
